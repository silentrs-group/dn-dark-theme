...
class IDEClassEditor extends AbstractFindButtonContainer
{
    ...
    public function applyCssToButtonContainer()
    {
        ...
        foreach ($container->children as $item) {
            ...
            switch ($key) {
                case 0: $item->graphic->classes->add("button-hide");         break;
                case 1: $item->graphic->classes->add("button-split-screen"); break;
